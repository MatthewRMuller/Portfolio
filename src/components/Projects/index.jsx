  ...
  const works = [
    {
      ...
      year: "2025",
      img: work1,
      title: "Architected real-time skin analysis platform using OpenAI.",
      detail: "Developed responsive UI with TailwindCSS and GSAP animations, implementing dynamic skincare recommendation cards with 60% improved engagement.",
    },
    {
      client: "NFT",
      year: "2025",
      img: work2,
      title: "nft website virtual internship.",
      detail: "Developed a fully functional NFT search platform using React with GSAP for animations. Integrated a search API with a responsive design."
    },
    {
      client: "I-phone Clone",
      year: "2024",
      img: work3,
      title: "Fully interactable 3D I-phone website clone",
      detail: "Designed animated hero section and a fully interactive 3D iPhone model using ThreeJS.",
    },
  ]
