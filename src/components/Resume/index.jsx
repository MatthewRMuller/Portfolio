        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Matthew Muller"} />
              </h2>
              <h4>
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                <a href="https://github.com/MatthewRMuller" target="_blank" rel="noreferrer">
                  <Icon img={githubIcon} />
                </a>
                <a href="https://www.linkedin.com/in/matthew-muller-38b384112/" target="_blank" rel="noreferrer">
                  <Icon img={linkedinIcon} />
                </a>
                <a href="https://docs.google.com/document/d/1ohZX5w6EsfwWG0I_9TDb-GPclWIxO8fz" target="_blank" rel="noreferrer">
                  <Icon img={fileIcon} />
                </a>
              </motion.div>
            </div>
